...
import { AboutTradeyardSection } from '../sections/AboutTradeyardSection/AboutTradeyardSection'
...
export function LandingPage({ onTryNowClick }: LandingPageProps) {
  return (
    <main className="min-h-screen bg-[#050505] text-[#f3f0e7]">
      ...
      <AboutTradeyardSection />
      <ProblemSection />
      <StatsSection />
      <FeaturesSection />
      <UseCasesSection onTryNowClick={onTryNowClick} />
      <WorkflowSection />
      <RolesSection />
      <MockupSection />
      <SecuritySection />
